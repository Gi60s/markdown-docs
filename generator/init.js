    ...
    module.exports = {
      ...
      template: {
        ...
        finePrint: '<p>This is some mighty find print. Yes, some mighty fine print.</p>' +
          '<p><strong>NOTE:</strong> Book icon obtained under the <a href="https://creativecommons.org/licenses/by/3.0/" target="_blank">Creative Commons (Attribution 3.0 Unported)</a> license, created by <a href="https://www.iconfinder.com/laurareen">Laura Reen</a>.</p>',
        footerLinks: [
